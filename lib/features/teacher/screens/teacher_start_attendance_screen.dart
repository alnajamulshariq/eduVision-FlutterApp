...
class _TeacherStartAttendanceScreenState
      ...
      children: [
        ...
        ModulePanel(
          ...
          child: PrimaryButton(
            ...
            onPressed: _status == AttendanceDemoStatus.idle
                ? _startDemoSession
                : null,
          ),
        ),
  ...
  String get _primaryButtonLabel {
    return switch (_status) {
      AttendanceDemoStatus.idle => 'Start Demo Session',
    ...
    return ModulePanel(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'Timetable validation allows this session to start during the '
            'assigned class window.',
